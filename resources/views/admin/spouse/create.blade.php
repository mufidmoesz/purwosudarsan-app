    ...
    <div class="admin-layout d-lg-flex">
        ...
        <main class="admin-main flex-grow-1">
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-1">Add Spouse Relationship</h1>
                    <p class="text-muted mb-0">Link two people together as partners.</p>
                </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.spouses.store') }}">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="spouse_id" class="form-select @error('spouse_id') is-invalid @enderror" required>
                                    ...
                                    @foreach ($people as $person)
                                        <option value="{{ $person->id }}" {{ (string) old('spouse_id') === (string) $person->id ? 'selected' : '' }}>
                                            {{ $person->name }}
                                        </option>
                                    @endforeach
                                </select>
